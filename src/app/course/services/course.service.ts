...
export class CourseService {
  ...
  uploadCourseImage(
    mimeType: string
  ): Observable<UploadCourseImageResponseDTO> {
  ...
  uploadCourseLectureVideo(
    mimeType: string
  ): Observable<UploadCourseLectureVideoResponseDTO> {
  ...
  uploadCourseLectureSubtitle(
    mimeType: string
  ): Observable<UploadCourseLectureSubtitleResponseDTO> {
  ...
  createCourse(
    ...
    return this._httpClient.post<CreateCourseResponseDTO>(
      `${this._courseApiUrl}/create-by-instructor`,
      course
    );
  }
  ...
  ): Observable<UpdateCourseResponseDTO> {
    return this._httpClient.post<UpdateCourseResponseDTO>(
      `${this._courseApiUrl}/update-by-instructor`,
      course
    );
  }

  getAllCourses(): Observable<GetAllCoursesResponseDTO[]> {
    return this._httpClient.get<GetAllCoursesResponseDTO[]>(
      `${this._courseApiUrl}/all-by-instructor`
    );
  }

  getCourse(courseId: string): Observable<GetCourseResponseDTO> {
    return this._httpClient.get<GetCourseResponseDTO>(
      `${this._courseApiUrl}/by-instructor?courseId=${courseId}`
    );
  }
}
